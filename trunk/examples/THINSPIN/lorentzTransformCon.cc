// Library       : THINSPIN
// File          : examples/THINSPIN/lorentzTransformCon.cc
// Copyright     : see Copyright file
// Author        :
// C++ version   : J.Talman

#ifndef THINSPIN_LORENTZ_TRANSFORM_CON_CC
#define THINSPIN_LORENTZ_TRANSFORM_CON_CC

void lorentzTransformCon(const THINSPIN::fourVector& in, const THINSPIN::threeVector beta, const double gamma, THINSPIN::fourVector& out){
