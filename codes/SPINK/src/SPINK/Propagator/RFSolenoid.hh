...
#ifndef UAL_SPINK_RFSOLENOID_HH
#define UAL_SPINK_RFSOLENOID_HH
...
namespace SPINK {
  ...
  /** Spink-specific RF Solenoid (Tracker) */

  class RFSolenoid : public TEAPOT::BasicTracker {
  ...
  public:
    ...
    /** Copy Constructor */
    RFSolenoid(const RFSolenoid& rft);
  ...
  private:
    ...
    void init();
    void copy(const RFSolenoid& rft);
