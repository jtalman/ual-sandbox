...
Matrix4& Matrix4::invertProjective()
{
    ...
    double determinant = dcab[0] * dcab[3] - dcab[1] * dcab[2];
    if(fabs(determinant) <= 0.00001f)
    {
        return identity();
    }
...
///////////////////////////////////////////////////////////////////////////////
double Matrix4::getCofactor(double m0, double m1, double m2,
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::rotate(double angle, const Vector3& axis)
{
...
{
    double c = cosf(angle * DEG2RAD);    // cosine
    double s = sinf(angle * DEG2RAD);    // sine
    double xx = x * x;
    double xy = x * y;
    double xz = x * z;
    double yy = y * y;
