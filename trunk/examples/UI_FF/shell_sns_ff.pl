...
$shell->addMap("elements" => "^(qfh1)\$",
               "map" => "./quadff/fr1qf.zmap");
$shell->addMap("elements" => "^(qfh2)\$",
               "map" => "./quadff/fr2qf.zmap");
$shell->addMap("elements" => "^(qflh1)\$",
               "map" => "./quadff/fr1qfc.zmap");
$shell->addMap("elements" => "^(qflh2)\$",
               "map" => "./quadff/fr2qfc.zmap");
$shell->addMap("elements" => "^(qdmh1)\$",
               "map" => "./quadff/fr1qdm.zmap");
$shell->addMap("elements" => "^(qdmh2)\$",
               "map" => "./quadff/fr2qdm.zmap");
$shell->addMap("elements" => "^(qdch1)\$",
               "map" => "./quadff/fr1qdc.zmap");
$shell->addMap("elements" => "^(qdch2)\$",
               "map" => "./quadff/fr2qdc.zmap");
$shell->addMap("elements" => "^(qfbh1)\$",
               "map" => "./quadff/fr1qf.zmap");
