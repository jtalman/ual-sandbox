...
namespace ETEAPOT2 {
 class M_bend : public UAL::PropagatorNode {
  public:
#include "ETEAPOT2/Integrator/M_bendMethods/class.methods"

#include "ETEAPOT2/Integrator/M_bendMethods/propagate.method"
