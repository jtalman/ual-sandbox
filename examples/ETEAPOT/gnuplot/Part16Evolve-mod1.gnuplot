...
set terminal x11 2
# set output "eps/16/Part16.i:x.png"
...
set terminal x11 3
# set output "eps/16/Part16.i:y.png"
...
set terminal x11 4
# set output "eps/16/Part16.ct:de.png"
...
set terminal x11 1
# set output "eps/16/Part16.i:Sx.png"
...
y0 = a
FIT_LIMIT = 0.002
fit g(x) 'IG' i 16 u 2:10:(1.0e-6) via w,A,x0,y0
