// Library       : THINSPIN
// File          : examples/THINSPIN/lorentzTransformForTracker.cc
// Copyright     : see Copyright file
// Author        :
// C++ version   : J.Talman

#ifndef THINSPIN_LORENTZ_TRANSFORM_FOR_TRACKER_CC
#define THINSPIN_LORENTZ_TRANSFORM_FOR_TRACKER_CC

void lorentzTransformForTracker(const THINSPIN::fourVector& in, const THINSPIN::threeVector beta, const double gamma, THINSPIN::fourVector& out){
