#ifndef UAL_MIA_BPM_HH
#define UAL_MIA_BPM_HH
...
namespace MIA {
  ...
  class BPM : public UAL::PropagatorNode {
  ...
  public:
    ...
    /** Return a name of the associated element */
    const std::string&  getName() const;   

    /** Return a type (h, v, hv) of the associated element */
