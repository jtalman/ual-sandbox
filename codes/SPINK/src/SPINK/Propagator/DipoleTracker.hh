// Library       : SPINK
// File          : SPINK/Propagator/DipoleTracker.hh
// Copyright     : see Copyright file
// Author        : A.Luccio
// C++ version   : N.Malitsky, V.Ptitsyn

#ifndef UAL_SPINK_DIPOLE_TRACKER_HH
#define UAL_SPINK_DIPOLE_TRACKER_HH
...
namespace SPINK {
  ...
  class DipoleTracker : public SpinPropagator {
  ...
  public:
   ...
   /** Copy constructor */
    DipoleTracker(const DipoleTracker& st);
 ...
 protected:
  ...
  private:
    ...
    void copy(const DipoleTracker& st);

  };

  class DipoleTrackerRegister
  {
    public:

    DipoleTrackerRegister();
  };
