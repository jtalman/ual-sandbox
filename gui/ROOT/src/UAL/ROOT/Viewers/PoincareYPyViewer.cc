...
UAL::ROOT::PoincareYPyViewer::PoincareYPyViewer(UAL::QT::BasicPlayer* player)
  : UAL::ROOT::PoincareViewer(player)
{
  ...
  */
  ...
  m_tinyGraph->SetTitle("Poincare Y-PY Plot");
  ...
  if (turn > 0) updateViewer(turn);
    ...
    m_tinyGraph->Draw("AP");
    m_tinyGraph->GetXaxis()->SetTitle("y, m");
    m_tinyGraph->GetYaxis()->SetTitle("py/p0, rad");
    m_tinyGraph->GetYaxis()->CenterTitle();
    m_tinyGraph->SetMarkerStyle(11);
    m_tinyGraph->SetMarkerColor(8);
...
void UAL::ROOT::PoincareYPyViewer::updateViewer(int turn)
{

  // std::cout << "ROOT::PoincareXPxViewer::updateViewer turn:" << turn  << std::endl;
  if(turn < 1) return;
...
void UAL::ROOT::PoincareYPyViewer::closeEvent(QCloseEvent* ce)
{

  ce->accept();
  p_player->removeViewer("UAL::ROOT::PoincareYPyViewer");

}

void UAL::ROOT::PoincareYPyViewer::initPoints()
{

}

void UAL::ROOT::PoincareYPyViewer::updatePoints(int turn)
{
