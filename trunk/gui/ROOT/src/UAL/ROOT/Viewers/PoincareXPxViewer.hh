#ifndef UAL_ROOT_POINCARE_XPX_VIEWER_HH
#define UAL_ROOT_POINCARE_XPX_VIEWER_HH
...
namespace UAL
{
  ...
  class PoincareXPxViewer : public PoincareViewer
  {
  ...
  public:
    ...
    /** Constructor */
    PoincareXPxViewer(UAL::QT::BasicPlayer* player);
