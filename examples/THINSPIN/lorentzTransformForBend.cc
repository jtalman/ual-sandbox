// Library       : THINSPIN
// File          : examples/THINSPIN/lorentzTransformForBend.cc
// Copyright     : see Copyright file
// Author        :
// C++ version   : J.Talman

#ifndef THINSPIN_LORENTZ_TRANSFORM_FOR_BEND_CC
#define THINSPIN_LORENTZ_TRANSFORM_FOR_BEND_CC

void lorentzTransformForBend(const THINSPIN::fourVector& in, const THINSPIN::threeVector beta, const double gamma, THINSPIN::fourVector& out){
