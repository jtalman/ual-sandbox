...
#include "SPINK/Tracker/MatrixTracker.hh"

PacLattice SPINK::MatrixTracker::s_lattice;
Teapot     SPINK::MatrixTracker::s_teapot;

SPINK::MatrixTracker::MatrixTracker()
{
  init();
}

SPINK::MatrixTracker::MatrixTracker(const SPINK::MatrixTracker& st)
{
  copy(st);
}
...
const SPINK::MatrixTracker& SPINK::MatrixTracker::operator=(const SPINK::MatrixTracker& st)
{
  copy(st);
  return *this;
}

UAL::PropagatorNode* SPINK::MatrixTracker::clone()
{
  return new SPINK::MatrixTracker(*this);
}

void SPINK::MatrixTracker::setLatticeElements(const UAL::AcceleratorNode& sequence, int is0, int is1,
...
UAL::AcceleratorNode& SPINK::MatrixTracker::getFrontAcceleratorNode()
{
  return m_frontNode;
}

UAL::AcceleratorNode& SPINK::MatrixTracker::getBackAcceleratorNode()
{
  return m_backNode;
}

void SPINK::MatrixTracker::setMap(const PacVTps& vtps)
{
...
void SPINK::MatrixTracker::propagate(UAL::Probe& probe)
{
...
void SPINK::MatrixTracker::copy(const SPINK::MatrixTracker& mt)
{
  m_l = mt.m_l;
...
SPINK::MatrixTrackerRegister::MatrixTrackerRegister()
{
  UAL::PropagatorNodePtr nodePtr(new SPINK::MatrixTracker());
  UAL::PropagatorFactory::getInstance().add("SPINK::MatrixTracker", nodePtr);
}

static SPINK::MatrixTrackerRegister theSpinkMatrixTrackerRegisterSingleton; 
