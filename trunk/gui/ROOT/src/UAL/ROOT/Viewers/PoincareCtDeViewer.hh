#ifndef UAL_ROOT_POINCARE_CTDE_VIEWER_HH
#define UAL_ROOT_POINCARE_CTDE_VIEWER_HH
...
namespace UAL
{
  ...
  class PoincareCtDeViewer : public PoincareViewer
  {
  ...
  public:
    ...
    /** Constructor */
    PoincareCtDeViewer(UAL::QT::BasicPlayer* player);
