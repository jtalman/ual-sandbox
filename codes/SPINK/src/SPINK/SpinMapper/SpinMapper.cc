...
std::vector<PAC::Position> SPINK::SpinMapper::s_positions(64);

SPINK::SpinMapper::SpinMapper()
{
...
void SPINK::SpinMapper::setLatticeElements(const UAL::AcceleratorNode& sequence, 
					   int is0, int is1,
...
void SPINK::SpinMapper::propagate(UAL::Probe& b)
{
