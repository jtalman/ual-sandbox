...
p 'NikolayOut' u 3:5 w l lw 1

set ylabel 'p[1] = dx/dz'
set terminal x11 11
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:6 w l lw 1

set ylabel 'p[2] = y'
set terminal x11 12
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:7 w l lw 1

set ylabel 'p[3] = dy/dz'
set terminal x11 13
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:8 w l lw 1

set ylabel 'p[4] = -c delta t'
set terminal x11 14
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:9 w l lw 1

set ylabel 'p[5] = delta E / pDc'
set terminal x11 15
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:10 w l lw 1

set ylabel 'S[0] = Sx'
set terminal x11 16 size 800,600 position 400,200 
set title "+x1typ, 0, 0, 0, 0, 0"
p 'NikolayOut' u 3:11 w l lw 1
