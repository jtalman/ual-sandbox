//# Library       : ACCSIM
//# File          : ACCSIM/Base/TeapotGenerator.hh
//# Copyright     : see Copyright file
//# Original code : TEAPOT
//# C++ version   : N.Malitsky 

#ifndef UAL_ACCSIM_TEAPOT_GENERATOR_HH
#define UAL_ACCSIM_TEAPOT_GENERATOR_HH

#define ACCSIM_TEAPOT_MAXINT 1000000000

/** The TeapotGenerator class produces normal (Gaussian) 
    deviates based on the TEAPOT approach.  
*/ 
...
namespace ACCSIM {
  ...
  public:
    ...
    /** Constructor */
    TeapotGenerator(int seed);

    /** Destructor */
    virtual ~TeapotGenerator();
