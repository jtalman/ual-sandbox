...
UAL::ADXFSolenoidHandler::ADXFSolenoidHandler()
{
}

void UAL::ADXFSolenoidHandler::startElement(const   XMLCh* const    uri,
...
void UAL::ADXFSolenoidHandler::endElement(const   XMLCh* const    uri,
				       const   XMLCh* const    localname,
				       const   XMLCh* const    qname)
{
    char* message = XMLString::transcode(localname);
...
void UAL::ADXFSolenoidHandler::fatalError(const SAXParseException& exception)
{
    char* message = XMLString::transcode(exception.getMessage());
    cout << "ADXFSolenoidHandler: Fatal Error: " << message
