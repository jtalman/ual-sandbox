// Library       : THINSPIN
// File          : examples/THINSPIN/getB2tw.cc
// Copyright     : see Copyright file
// Author        :
// C++ version   : J.Talman

void getB2tw(PacElemMultipole* mult, const PacElemOffset* offset, const double rkicks, const double in1, const double in2, double& B2tw){
