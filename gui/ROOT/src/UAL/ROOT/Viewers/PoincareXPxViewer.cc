...
UAL::ROOT::PoincareXPxViewer::PoincareXPxViewer(UAL::QT::BasicPlayer* player)
  : UAL::ROOT::PoincareViewer(player)
{
  ...
  */
  ...
  m_tinyGraph->SetTitle("Poincare X-PX Plot");
...
void UAL::ROOT::PoincareXPxViewer::updateViewer(int turn)
{
...
void UAL::ROOT::PoincareXPxViewer::closeEvent(QCloseEvent* ce)
{

  ce->accept();
  p_player->removeViewer("UAL::ROOT::PoincareXPxViewer");

}

void UAL::ROOT::PoincareXPxViewer::initPoints()
{

}

void UAL::ROOT::PoincareXPxViewer::updatePoints(int turn)
{
