...
p 'out/IG' i 0 u 2:10 w l lw 1

set terminal x11 11
set title "0.005, 0, 0, 0, 0, 0"
p 'out/IG' i 11 u 2:10 w l lw 1

set terminal x11 12
set title "-0.005, 0, 0, 0, 0, 0"
p 'out/IG' i 12 u 2:10 w l lw 1

set terminal x11 13
set title " 0, 0.0002, 0, 0, 0, 0"
p 'out/IG' i 13 u 2:10 w l lw 1

set terminal x11 14
set title " 0, -0.0002, 0, 0, 0, 0"
p 'out/IG' i 14 u 2:10 w l lw 1

set terminal x11 15
set title "0, 0, 0.01, 0, 0, 0"
p 'out/IG' i 15 u 2:10 w l lw 1

set terminal x11 16
set title " 0, 0, 0, 0.001, 0, 0"
p 'out/IG' i 16 u 2:10 w l lw 1

set terminal x11 17
set title "0, 0, 0, 0, 0, 5.85e-5"
p 'out/IG' i 17 u 2:10 w l lw 1

set terminal x11 18
set title "0, 0, 0, 0, 0,-5.85e-5"
p 'out/IG' i 18 u 2:10 w l lw 1
